...
from solver_phase4.runner import run_solver
from solver_phase4.config import SolverConfig
...
EOF
"""
    vrp_path = tmp_path / "tiny4.vrp"
    vrp_path.write_text(content)
    return vrp_path


def test_solver_phase4_feasible(tmp_path):
