...
from solver_phase3.runner import run_solver
from solver_phase3.config import SolverConfig
...
EOF
"""
    vrp_path = tmp_path / "tiny3.vrp"
    vrp_path.write_text(content)
    return vrp_path


def test_solver_phase3_feasible(tmp_path):
